...
<title>B2B Cotação Acesso</title>
<meta charset="utf-8">
...
<body>
	...
	<section> <article>
	<form method="post" action="AcessoControlador">
		<h1>Acesso</h1>

		<input type=text id=acao name=acao value="acessar" hidden=true>
		<p>
			<label> <span>usuário </span><input type=text id=usuarioInput
				name=usuarioInput autofocus>
			</label>
		</p>

		<p>
			<label> <span>senha</span><input type=password id=senhaInput
				name=senhaInput></label>
		</p>

		<p>
			<button name=btnLogin id=btnLogin>Entrar</button>

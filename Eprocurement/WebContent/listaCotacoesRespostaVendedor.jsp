 ...
 %>
	...
	<form method="post" action="EnviarControlador">
		...
		<table>
			...
			%>
			<tr align="left">
				<td><%= (Long) listaCotacao.get(i) %></td>
				<td><a href="RespostaControlador?acao=abrirCotacaoVendedor&idCotacao=<%out.println((Long) listaCotacao.get(i)); %>">Responder Cotação</a></td>
				</label></td>
			</tr>
			<%
				}

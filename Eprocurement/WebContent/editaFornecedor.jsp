...
<title>B2B Cotação Fornecedores</title>
<meta charset="utf-8">
...
<body>
	...
	<section> <article>
	<form method="post" action="AtualizaFornecedor">
		...
		<input type=text id=acao name=acao value="editarFornecedor"
			hidden=true> <input type=number id=idInput name=idInput
			hidden=true value="<%=fornecedor.getId()%>" required>

		<p>
			<label> <span>nome fantasia</span><input type=text
				id=nomeFantasiaInput name=nomeFantasiaInput
				value="<%=fornecedor.getNomeFantasia()%>" required></label>
		</p>
		<p>
			<label> <span>razão Social</span><input type=text
				id=razaoSocialInput name=razaoSocialInput
				value="<%=fornecedor.getRazaoSocial()%>" required></label> 
		</p>
		<p>
			<label> <span>cnpj</span><input type=text id=cnpjInput
				name=cnpjInput value="<%=fornecedor.getCnpj()%>" required></label>
		</p>

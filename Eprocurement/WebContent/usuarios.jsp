...
<body>
	...
	<form method="post" action="Controlador">
		...
		<h1>Usuários</h1>
		<input type=text id=acao name=acao value="adicionarUsuario"
			hidden=true>
		<p>
			<label> <span>perfil</span><input type=text list=browsers
				id=perfilInput name=perfilInput autofocus> <datalist
					id=browsers>
		...
		<p>
			<label> <span>login</span><input type=text id=loginInput
				name=loginInput required></label> 
		</p>
		<p>
			<label> <span>senha</span><input type=password id=senhaInput
				name=senhaInput required></label>
		</p>

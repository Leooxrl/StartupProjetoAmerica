...
<body>
 ...
 %>
	...
	<section> <article>
	<form method="post" action="EncerraControlador">
		<h1>Encerrar cotações</h1>
		<p>Cotações encerradas não poderão mais ser respondidas pelos
			vendedores</p>
		<table>
			...
			<tr align="left">
				...
				<td><a href="EmailControlador?acao=detalhe&idCotacao=<%out.println(((Cotacao) listaCotacao.get(i)).getId()); %>&tela=EncerraControlador">Detalhes da cotação</a></td>
				<td><label> <a href="EncerraControlador?acao=encerrar&idCotacao=<%out.println(((Cotacao) listaCotacao.get(i)).getId()); %>">Encerrar</a>
				</label></td>
			</tr>
			<%
				}

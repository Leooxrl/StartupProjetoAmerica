...
<title>B2B Cotação Produtos</title>
<meta charset="utf-8">
...
<body>
	...
	<h2>B2B NEGOCIAÇÃO DE PREÇOS ENTRE SUPERMERCADISTAS E FORNECEDORES
		v1</h2>
	</hgroup> </header>
	...
	<form action="Controlador" method="post">
		...
		<h1>Produtos</h1>
		<input type=text id=acao name=acao value="adicionarProduto"
			hidden=true>
		<p>
			<label> <span>descrição</span><input type=text
				id=descricaoInput name=descricaoInput required autofocus></label>
		</p>
